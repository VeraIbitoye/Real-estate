...
<div className="container">
    <div className="row">
        <h3 className='text-center text-decoration-underline'>Project</h3>
        <div className="col"><div class="card" style={{width:'18rem', height:'400px'}}>
  ...
  <div class="card-body">
    ...
    <a href="#" class="btn btn-primary">Go somewhere</a>
        ...
        <div className="col"><div class="card" style={{width:'18rem', height:'400px'}}>
  <img src="https://images.pexels.com/photos/3288102/pexels-photo-3288102.png?auto=compress&cs=tinysrgb&w=600" class="card-img-top" alt="..."/>
  <div class="card-body">
